...
export default function DriverEmergency() {
  ...
  useEffect(() => {
    Promise.allSettled([
      ...
      if (p.status === 'fulfilled') {
        ...
        const ec = p.value.data.emergencyContact || p.value.data.EmergencyContact
        const ep = p.value.data.emergencyPhone   || p.value.data.EmergencyPhone
  ...
  return (
    <Layout title="Emergency Contacts" role="Driver" showBack userInitials={initials} unreadCount={unread}>
      <div className="page-inner" style={{ maxWidth: 540 }}>
        ...
        {loading ? (
          ...
          <>
            ...
            {/* New contact form */}
            {addingNew && (
              <div className="card" style={{ marginBottom: 10, border: '1.5px dashed var(--blue)' }}>
